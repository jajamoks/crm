...
if (!$CI->db->field_exists('commodity_sub_part_number' ,db_prefix() . 'items')) { 
  $CI->db->query('ALTER TABLE `' . db_prefix() . "items`
    ADD COLUMN `commodity_sub_part_number` text NULL;
    ");
}
if (!$CI->db->field_exists('commodity_made_in' ,db_prefix() . 'items')) { 
  $CI->db->query('ALTER TABLE `' . db_prefix() . "items`
    ADD COLUMN `commodity_made_in` text NULL;
    ");
}
if (!$CI->db->field_exists('commodity_specs' ,db_prefix() . 'items')) { 
  $CI->db->query('ALTER TABLE `' . db_prefix() . "items`
    ADD COLUMN `commodity_specs` text NULL;
    ");
}
